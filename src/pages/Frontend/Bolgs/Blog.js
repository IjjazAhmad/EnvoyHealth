                ...
                <div className="container">
                    <div className="row">
                        <div className="col-7">
                            ...
                            <p>Over the years, I have received a lot of feedback from <br /> recruitment agencies and an interesting fact which has com...</p>
                            <button className="btn p-2 px-4 text-primary border border-primary rounded-pill">READ MORE</button>
                        </div>
                        <div className="col-5">
                    ...
                    <div className="row mt-5">
                        ...
                        <div className="row">
                            <div className="col p-2">
                                <button className="btn btn-primary text-white mx-3">Trending</button>
                                <button className="btn border mx-3">Resume</button>
                                <button className="btn border mx-3">Cover Letter</button>
                                <button className="btn border mx-3">LinkedIn Profile</button>
                                <button className="btn border mx-3">Returning Client</button>
                            </div>
                        ...
                        <div className="row mt-5">
                            ...
                            <button className="btn mx-auto w-25 mt-5  p-2 px-5 text-primary border border-primary rounded-pill">Load More</button>
                        </div>
                    </div>
                </div>
            </div>
